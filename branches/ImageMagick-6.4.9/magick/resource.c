...
static MagickBooleanType GetPathTemplate(char *path)
{
  ...
  if (directory == (char *) NULL)
    directory=GetConfigureOption("MAGICK_TEMPORARY_PATH");
  if (directory == (char *) NULL)
    {
      ExceptionInfo
        *exception;
...
MagickExport void InitializeMagickResources(void)
{
  ...
  */
  ...
  if (limit == (char *) NULL)
    limit=GetConfigureOption("MAGICK_AREA_LIMIT");
  if (limit != (char *) NULL)
    {
  ...
  if (limit == (char *) NULL)
    limit=GetConfigureOption("MAGICK_MEMORY_LIMIT");
  if (limit != (char *) NULL)
    {
  ...
  if (limit == (char *) NULL)
    limit=GetConfigureOption("MAGICK_MAP_LIMIT");
  if (limit != (char *) NULL)
    {
  ...
  if (limit == (char *) NULL)
    limit=GetConfigureOption("MAGICK_DISK_LIMIT");
  if (limit != (char *) NULL)
    {
  ...
  if (limit == (char *) NULL)
    limit=GetConfigureOption("MAGICK_FILE_LIMIT");
  if (limit != (char *) NULL)
    {
  ...
  if (limit == (char *) NULL)
    limit=GetConfigureOption("MAGICK_THREAD_LIMIT");
  if (limit != (char *) NULL)
    {
