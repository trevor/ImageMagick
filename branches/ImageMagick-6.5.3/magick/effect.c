...
static Quantum **AcquirePixelThreadSet(const size_t count)
{
  ...
  pixels=(Quantum **) AcquireCachelineMemory(number_threads*sizeof(*pixels));
...
static MedianPixelList *AcquireMedianPixelList(const unsigned long width)
{
  ...
  pixel_list=(MedianPixelList *) AcquireCachelineMemory(sizeof(*pixel_list));
  if (pixel_list == (MedianPixelList *) NULL)
    return(pixel_list);
  ...
  const unsigned long width)
{
  ...
  number_threads=GetOpenMPMaximumThreads();
  pixel_list=(MedianPixelList **) AcquireCachelineMemory(number_threads*
    sizeof(*pixel_list));
  if (pixel_list == (MedianPixelList **) NULL)
    return((MedianPixelList **) NULL);
