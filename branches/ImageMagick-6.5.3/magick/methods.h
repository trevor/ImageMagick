...
#define GetOpenMPMaximumThreads  PrependMagickMethod(GetOpenMPMaximumThreads)
...
#define GetOpenMPThreadId  PrependMagickMethod(GetOpenMPThreadId)
...
#define SetOpenMPMaximumThreads  PrependMagickMethod(SetOpenMPMaximumThreads)
