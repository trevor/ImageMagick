...
%                                                                             %
%                                                                             %
%   A c q u i r e C a c h e l i n e M e m o r y                               %
%                                                                             %
%                                                                             %
%                                                                             %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%  AcquireCachelineMemory() returns a pointer to a block of memory at least size
%  bytes but not less than CachelineSize bytes suitably aligned for any use.
%
%  The format of the AcquireCachelineMemory method is:
%
%      void *AcquireCachelineMemory(const size_t size)
%
%  A description of each parameter follows:
%
%    o size: the size of the memory in bytes to allocate.
%
*/
MagickExport void *AcquireCachelineMemory(const size_t size)
{
  if (size > CachelineSize)
    return(AcquireMagickMemory(size));
  return(AcquireMagickMemory(CachelineSize));
}

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
